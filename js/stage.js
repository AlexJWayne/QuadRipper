...
(function() {
  ...
  window.Stage = (function() {
    ...
    Stage.prototype.levels = [Level1, Level2];
    ...
    Stage.prototype.createLevelMesh = function() {
      ...
      scene.add(this.mesh);
      floor = new THREE.Mesh(new THREE.PlaneGeometry(220, 220), new THREE.MeshPhongMaterial({
        color: 0xdddddd
      }));
      floor.position.z = -3;
      this.mesh.add(floor);
      return this.walls = (function() {
        ...
        for (i = _i = 0; _i <= 3; i = ++_i) {
          ...
          wall = new THREE.Mesh((function(func, args, ctor) {
    ...
    Stage.prototype.hit = function(enemy) {
      var _this = this;
      this.health -= 10;
      $('#health').html(this.health > 0 ? this.health : 0);
      this.showHit = true;
      if (this.health === 0) {
        return setTimeout((function() {
          return _this.reset();
